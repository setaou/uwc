...
Begin VB.Form WB1 
   ...
   Begin ComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         ...
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":2376
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":2A88
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":32DA
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":3B2C
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin ComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {0713E8C2-850A-101B-AFC0-4210102A8DA7} 
         NumListImages   =   4
         BeginProperty ListImage1 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":4286
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":4998
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":50AA
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {0713E8C3-850A-101B-AFC0-4210102A8DA7} 
            Picture         =   "WB1.frx":57BC
            Key             =   ""
         EndProperty
      EndProperty
   End
End
Attribute VB_Name = "WB1"
...
Public Sub Chargement(Fichier As String)
        ...
        If w.OpenFile(Fichier) = 1 Then
            ...
            Me.Caption = "UWC - " + GetTranslation(252, "Image Webshots") + " - (" + Fichier + ")"
            ...
            'Chargement des infos complémentaires de photos.txt (si disponible!)
            If PhotosTXT.AutoOpen(GetDirectory(Fichier)) = 1 Then
                PhotosTXT.SeekPicture GetFileName(Fichier)
                
                If Len(PhotosTXT.PictureTitle) Then Frame1.Caption = sprintf(GetTranslation(201, "Aperçu : %s"), PhotosTXT.PictureTitle)
                If Len(PhotosTXT.PictureTitle) Then Infos.AddItem sprintf(GetTranslation(203, " - Titre : %s"), PhotosTXT.PictureTitle)
                If Len(PhotosTXT.PictureCaption) Then Infos.AddItem sprintf(GetTranslation(204, " - Description : %s"), PhotosTXT.PictureCaption)
                If Len(PhotosTXT.PictureCredit) Then Infos.AddItem sprintf(GetTranslation(205, " - Credits : %s"), PhotosTXT.PictureCredit)
                If Len(PhotosTXT.AlbumTopicName) Then
                    Infos.AddItem GetTranslation(208, " - Catégorie : ")
                    Infos.AddItem "    o " + PhotosTXT.AlbumTopicName
                End If
                If Len(PhotosTXT.AlbumTitle) Then
                    Infos.AddItem "       '-> " + PhotosTXT.AlbumTitle
                End If
                If Len(PhotosTXT.PictureID) Then Infos.AddItem sprintf(GetTranslation(206, " - ID : %s"), PhotosTXT.PictureID)
            End If
        
            Infos.AddItem sprintf(GetTranslation(207, " - Dimensions : %dx%d"), PreviewInfos.Original.Width, PreviewInfos.Original.Height)
            
            Frame1.Caption = Frame1.Caption + " (" + CStr(PreviewInfos.Original.Width) + "x" + CStr(PreviewInfos.Original.Height) + ")"
...
Private Sub Toolbar1_ButtonClick(ByVal Button As ComctlLib.Button)
    Select Case Button.index
        Case 1 'Sauvegarder
            ...
            If Len(PhotosTXT.PictureTitle) > 0 Then ret = FormatPath(PhotosTXT.PictureTitle)
